...
`;
            ...
            boxSpan2.addEventListener('click', () => {
                ...
                // let boxA = document.getElementById('boxA'+index)
                ...
                //     urlinput.value = boxA.href;
                //     nameinput.value = boxA.innerText;
                //         inputBox.style.width = '35%'
                //         inputBox.style.height = '50vh'
                ...
                //              let nameinput = document.getElementById('nameInput')
                //     let urlinput = document.getElementById('urlInput')
                //         let st = nameinput.value
                //             boxA.href = urlinput.value;
                //             boxA.innerText = st[0].toUpperCase() + st.slice(1);
...
`;
                ...
                Array.from(document.getElementsByClassName('themeselect')).forEach((element) => {
                    element.addEventListener('click', (e) => {
                        ...
                        console.log(box);
                        box.style.backgroundImage = `url('${srcValue}')`;
                         localStorage.setItem('background' + key.slice(4),srcValue);
